        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href={t("social.instagram")} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#666] hover:text-foreground transition-colors">
              ...
              <a href={t("social.linkedin")} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#666] hover:text-foreground transition-colors">
              ...
              <a href={t("social.whatsapp")} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-[#666] hover:text-foreground transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {solutionLinks.map(({ label, href }) => (
                <li key={href}>
                  <Link href={href} className="text-sm text-[#888] hover:text-foreground transition-colors">{label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {companyLinks.map(({ key, href }) => (
                <li key={key}>
                  <Link href={href} className="text-sm text-[#888] hover:text-foreground transition-colors">{tNav(key)}</Link>
                </li>
              ))}
              <li>
                <a href={t("platformUrl")} target="_blank" rel="noopener noreferrer" className="text-sm text-[#888] hover:text-foreground transition-colors">
                  Plataforma
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href={`mailto:${t("email")}`} className="text-sm text-[#888] hover:text-foreground transition-colors">{t("email")}</a></li>
              <li><a href={`tel:${t("phone")}`} className="text-sm text-[#888] hover:text-foreground transition-colors">{t("phone")}</a></li>
