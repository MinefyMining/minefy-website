    ...
    <footer className="bg-card border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href={t("social.instagram")} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href={t("social.linkedin")} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href={t("social.whatsapp")} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href={t("platformUrl")} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Plataforma
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-7xl px-6 py-4 flex flex-col gap-1.5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="text-xs text-muted-foreground">
            {t("dpo.label")}: {t("dpo.name")} ·{" "}
            <a href={`mailto:${t("dpo.email")}`} className="hover:text-foreground transition-colors">
              {t("dpo.email")}
            </a>
          </p>
        </div>
