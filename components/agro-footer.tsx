        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href={tFooter("social.instagram")} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-[#16A34A] transition-colors">
              ...
              <a href={tFooter("social.linkedin")} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-[#16A34A] transition-colors">
              ...
              <a href={tFooter("social.whatsapp")} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-muted-foreground hover:text-[#16A34A] transition-colors">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-[#16A34A] mb-4">{t("columns.contact")}</h3>
            <ul className="space-y-2.5">
